...
@section('content')
    ...
    <div id="members"
        data-list='{"valueNames":["customer","email","city","joined"],"page":10,"pagination":true}'>
                    ...
                    <thead>
                        <tr>
                            <th class="sort align-middle" scope="col" data-sort="customer"
                                style="width:15%; min-width:200px;">USER</th>
                    ...
                    <tbody class="list" id="members-table-body">
                        @forelse ($users as $user)
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                ...
                                <td class="joined align-middle white-space-nowrap text-body-tertiary text-end">{{$user->created_at->format('d M Y, H:i')}}</td>
