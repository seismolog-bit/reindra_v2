...
@section('content')
    ...
    <h2 class="text-bold text-body-emphasis mb-5">Technology</h2>
    <div id="members" data-list='{"valueNames":["title"],"page":10,"pagination":true}'>
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center"><button class="btn btn-link text-body me-4 px-0"><span
                    ...
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                        data-bs-target="#modalCreate"><span class="fas fa-plus me-2"></span> Add technology</button>
                        ...
                        @forelse ($technologies as $technology)
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                <td class="title align-middle white-space-nowrap"><a
                                        ...
                                        <h6 class="mb-0 ms-3 fw-semibold">{{ $technology->title }}</h6>
                                    </a></td>
                                <td class=" align-middle text-end white-space-nowrap text-body-tertiary">
                                    <div class="col-12 col-md-auto d-flex justify-content-end">
                                        <button type="button" class="btn btn-phoenix-primary btn-icon me-2"
                                            onclick="openEditModal({{ $technology->id }})">
                                            <span data-feather="edit"></span>
                                        </button>
                                        <form method="POST" action="{{ route('admin.technology.destroy', $technology) }}"
                                            class="d-inline"
...
@section('modal')
    @include('components.modals.technology-create')
    @include('components.modals.technology-edit')
@endsection
...
@section('script')
    ...
    <script>
        function openEditModal(technologyId) {

            // Ajax request to get technology data
            $.get('/admin/technology/' + technologyId + '/edit/', function(data) {
