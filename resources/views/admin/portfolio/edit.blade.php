...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-9">
            ...
            <form class="row g-3 mb-6" action="{{ route('admin.portfolio.update', $portfolio) }}" method="POST"
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="floatingInputGrid" type="text" placeholder="Project title"
                            name="title" value="{{ old('title') ?? $portfolio->title }}" required autofocus />
                    ...
                    <div class="col-12 gy-6">
                        <select class="form-select" id="organizerMultiple" data-choices="data-choices" multiple=""
                            ...
                            @foreach ($categories as $category)
                                @if (in_array($category->id, $portfolio->portfolio_categories))
                    ...
                    <div class="flatpickr-input-container">
                        <div class="form-floating">
                            <input class="form-control datetimepicker" id="floatingInputStartDate" type="text"
                                ...
                                value="{{ old('year') ?? $portfolio->year }}" name="year" required />
                ...
                <div class="col-sm-6 col-md-6">
                    <div class="form-floating">
                        <input class="form-control" id="floatingInputGrid" type="text" name="tech"
                            placeholder="Project title" value="{{ old('tech') ?? $portfolio->tech }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="floatingInputGrid" type="text" placeholder="Project title"
                            name="url" required value="{{ old('url') ?? $portfolio->url }}" /><label
                            for="floatingInputGrid">Project url</label>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="form-floating">
                        <textarea class="form-control" id="floatingProjectOverview" name="description" placeholder="Leave a comment here"
                            style="height: 100px" required>{{ old('description') ?? $portfolio->description }}</textarea><label for="floatingProjectOverview">project overview</label>
                    </div>
                </div>
